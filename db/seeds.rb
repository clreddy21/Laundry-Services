...
Customer.create(first_name: 'Angie', last_name: 'Jolie', email:
                'customer_1@gmail.com', password: 'testtest1',
                password_confirmation: 'testtest1', mobile: '9999999999')
Customer.create(first_name: 'johnny', last_name: 'depp', email:
                'customer_2@gmail.com', password: 'testtest1',
                password_confirmation: 'testtest1', mobile: '9999999998')
puts 'creating service providers'
service_provider_1 = ServiceProvider.create(first_name: 'Jaby', last_name:
                                            'Koay', email: 'sp_1@gmail.com',
                                            password: 'testtest1',
                                            password_confirmation: 'testtest1',
                                            mobile: '9999999997', latitude:
                                            17.509820, longitude: 78.595355,
                                            reviews_count: 6,
                                            average_review: 4.21)
service_provider_2 = ServiceProvider.create(first_name: 'Saint', last_name:
                                            'John', email: 'sp_2@gmail.com',
                                            password: 'testtest1',
                                            password_confirmation: 'testtest1',
                                            mobile: '9999999996', latitude:
...
Logistic.create(first_name: 'Logistic', last_name: '1', email: 'l1@gmail.com',
                password: 'testtest1', password_confirmation: 'testtest1',
                mobile: '9999999995')
Logistic.create(first_name: 'Logistic', last_name: '2', email: 'l2@gmail.com',
                password: 'testtest1', password_confirmation: 'testtest1',
                mobile: '9999999994')

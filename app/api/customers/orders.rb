  ...
  class Orders < Grape::API
    ...
    resource :test_gcm do
      ...
      post do
        ...
        registration_id = ['f35EpRroH-k:APA91bH5KJAXo2iKLNkJRvLgCrZDAHUCd3IMoD0ZC5PjOLO0VfoijtLE3bHRzoKvAzCcYqeTZ3Jr3ADHBLJlE-TNyXLB2MLfJyiGH-ZpksXcrY1jIyfDwQL6xFSl5bf3efyB8GNSTfCt']
    ...
    resource :create_order do
      ...
      post do
        ...
        if params[:payment_mode] == 'wallet' && params[:total_cost] > customer.wallet.amount
          ...
          service_provider_name = order.service_provider ? order.service_provider_name : ''
    ...
    resource :order_details do
      ...
      get do
        ...
        service_provider_mobile: service_provider_mobile, service_provider_id: order.service_provider_id, service_provider_address: service_provider_address,
